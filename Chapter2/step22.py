...
Variable.__rmul__ = mul  # 순서가 바뀔 경우에 대해서도 연산이 가능하게 함
...
Variable.__neg__ = neg  # Variable 클래스 연산자를 오버로드
...
y1 = 2.0 - x
y2 = x - 1.0
print(y1)  # result: variable(0.0)
print(y2)  # result: variable(1.0)
y3 = x**3
print(y3)  # result: variable(8.0)
